...
AMultiplayerMovementHud::AMultiplayerMovementHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AMultiplayerMovementHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		AMultiplayerMovementPawn* Vehicle = Cast<AMultiplayerMovementPawn>(GetOwningPawn());
